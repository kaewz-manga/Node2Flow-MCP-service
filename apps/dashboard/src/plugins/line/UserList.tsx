            ...
            <CardContent className="space-y-3">
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button className="" onClick={handleLookupUser} disabled={lookingUp || !userId.trim()}>
            ...
            <CardContent className="space-y-3">
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button className="" onClick={handleLookupGroup} disabled={lookingUpGroup || !groupId.trim()}>
