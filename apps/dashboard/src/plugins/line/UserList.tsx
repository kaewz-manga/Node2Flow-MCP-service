    ...
    <div className="space-y-6">
      ...
      <Card className="hover:shadow-md transition-all">
        <CardHeader>
          ...
          <CardDescription>Manage LINE users and groups through your AI assistant</CardDescription>
        </CardHeader>
        <CardContent className="pt-0">
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><em className="text-foreground">"Get profile for user U1234"</em></li>
            <li><em className="text-foreground">"List group members in group C5678"</em></li>
            <li><em className="text-foreground">"Check my bot's follower count"</em></li>
          </ul>
        </CardContent>
      </Card>
    </div>
