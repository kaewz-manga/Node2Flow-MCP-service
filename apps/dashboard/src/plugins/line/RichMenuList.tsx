      ...
      {!loading && (
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <Card className="bg-gradient-to-t from-primary/5 to-card shadow-sm">
            ...
            <CardFooter className="text-sm text-muted-foreground">
              <Star className="h-3.5 w-3.5 mr-1.5 text-primary" /> Active by default
            </CardFooter>
          </Card>
              ...
              <Card key={menu.richMenuId} className="hover:shadow-md transition-all">
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <Button variant="ghost" size="icon" className="h-7 w-7 hover:text-primary" onClick={() => handleSetDefault(menu.richMenuId)} title="Set as default">
