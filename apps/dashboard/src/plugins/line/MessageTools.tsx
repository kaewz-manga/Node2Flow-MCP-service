    ...
    <div className="space-y-6">
      ...
      <Card className="hover:shadow-md transition-all">
        <CardHeader>
          ...
          <CardDescription>Send and manage LINE messages through your AI assistant</CardDescription>
        </CardHeader>
        <CardContent className="pt-0">
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><em className="text-foreground">"Send a text message to user U1234"</em></li>
            <li><em className="text-foreground">"Broadcast a message to all followers"</em></li>
            <li><em className="text-foreground">"Send a flex message with buttons"</em></li>
          </ul>
        </CardContent>
      </Card>
    </div>
