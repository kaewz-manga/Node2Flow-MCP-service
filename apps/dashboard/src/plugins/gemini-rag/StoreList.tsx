      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage Gemini RAG knowledge bases via MCP tools <Badge variant="secondary" className="ml-1">4 tools</Badge>
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="bg-gradient-to-t from-primary/5 to-card shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">List Stores</CardTitle>
            </div>
            <CardDescription>View all your RAG knowledge base stores and their document counts</CardDescription>
          </CardHeader>
        ...
        <Card className="bg-gradient-to-t from-emerald-500/5 to-card shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-2">
            ...
            <CardDescription>Create a new knowledge base to organize your documents by topic</CardDescription>
          </CardHeader>
          <CardContent className="pt-0">
            <code className="text-xs bg-muted px-2 py-1 rounded text-muted-foreground">
        ...
        <Card className="bg-gradient-to-t from-purple-500/5 to-card shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">Inspect Store</CardTitle>
            </div>
            <CardDescription>Get detailed store info including document count and configuration</CardDescription>
          </CardHeader>
          <CardContent className="pt-0">
            <code className="text-xs bg-muted px-2 py-1 rounded text-muted-foreground">
              "Show details of my Product Docs store"
            </code>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-t from-amber-500/5 to-card shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">Delete Store</CardTitle>
            </div>
            <CardDescription>Remove stores and all associated documents permanently</CardDescription>
          </CardHeader>
          <CardContent className="pt-0">
            <code className="text-xs bg-muted px-2 py-1 rounded text-muted-foreground">
              "Delete the old documentation store"
            </code>
          </CardContent>
        </Card>
      </div>
