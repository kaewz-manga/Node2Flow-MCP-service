    ...
    <div className="space-y-6">
      ...
      <Card className="hover:shadow-md transition-all">
        <CardHeader>
          ...
          <CardDescription>Send and manage Telegram messages through your AI assistant</CardDescription>
        </CardHeader>
        <CardContent className="pt-0">
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><em className="text-foreground">"Send Hello to chat 123456789"</em></li>
            <li><em className="text-foreground">"Send a photo to my channel"</em></li>
            <li><em className="text-foreground">"Edit message #456 in chat 789"</em></li>
          </ul>
        </CardContent>
      </Card>
    </div>
