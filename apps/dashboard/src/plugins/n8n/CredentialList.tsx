  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-gradient-to-t from-green-500/5 to-card shadow-sm cursor-pointer hover:shadow-md transition-all" onClick={() => { setShowCreate(true); setShowUpdate(false); }}>
