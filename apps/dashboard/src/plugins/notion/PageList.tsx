import { FileText, Search, PenTool, Plus, Lightbulb } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Search and manage your Notion pages <Badge variant="secondary" className="ml-1">5 tools</Badge>
          </p>
        </div>
      </div>
        ...
        <Card className="bg-gradient-to-t from-primary/5 to-card shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">Search Pages</CardTitle>
            </div>
            <CardDescription>Find pages by title or content across your entire workspace</CardDescription>
          </CardHeader>
        ...
        <Card className="bg-gradient-to-t from-emerald-500/5 to-card shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">Create Pages</CardTitle>
            </div>
            <CardDescription>Create new pages in databases or as standalone workspace pages</CardDescription>
          </CardHeader>
          <CardContent className="pt-0">
            <code className="text-xs bg-muted px-2 py-1 rounded text-muted-foreground">
        ...
        <Card className="bg-gradient-to-t from-purple-500/5 to-card shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">Update Properties</CardTitle>
            </div>
            <CardDescription>Modify page titles, icons, covers, and database properties</CardDescription>
          </CardHeader>
          <CardContent className="pt-0">
            <code className="text-xs bg-muted px-2 py-1 rounded text-muted-foreground">
              "Update the title of page [ID]"
            </code>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-t from-amber-500/5 to-card shadow-sm hover:shadow-md transition-all">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">Retrieve Pages</CardTitle>
            </div>
            <CardDescription>Get full page details including all properties and parent info</CardDescription>
          </CardHeader>
          <CardContent className="pt-0">
            <code className="text-xs bg-muted px-2 py-1 rounded text-muted-foreground">
              "Get details of page [ID]"
            </code>
          </CardContent>
        </Card>
      </div>
