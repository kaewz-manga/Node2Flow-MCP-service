        ...
        <div className="space-y-8 text-n2f-text-secondary">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-n2f-elevated rounded-lg p-4"><h3 className="font-medium text-n2f-text mb-2">Access</h3><p className="text-sm">Request a copy of your personal data. Available in Dashboard &rarr; Settings.</p></div>
              <div className="bg-n2f-elevated rounded-lg p-4"><h3 className="font-medium text-n2f-text mb-2">Rectification</h3><p className="text-sm">Update inaccurate data directly in your account settings.</p></div>
              <div className="bg-n2f-elevated rounded-lg p-4"><h3 className="font-medium text-n2f-text mb-2">Erasure</h3><p className="text-sm">Delete your account and all associated data from Settings.</p></div>
              <div className="bg-n2f-elevated rounded-lg p-4"><h3 className="font-medium text-n2f-text mb-2">Portability</h3><p className="text-sm">Export your data in a machine-readable format (JSON).</p></div>
              <div className="bg-n2f-elevated rounded-lg p-4"><h3 className="font-medium text-n2f-text mb-2">Restriction</h3><p className="text-sm">Request limitation of processing by contacting us.</p></div>
              <div className="bg-n2f-elevated rounded-lg p-4"><h3 className="font-medium text-n2f-text mb-2">Objection</h3><p className="text-sm">Object to processing for specific purposes by contacting us.</p></div>
            </div>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-2">
              <li>Go to <strong className="text-n2f-text">Dashboard &rarr; Settings</strong></li>
            ...
            <p className="mt-3 text-n2f-text-muted text-sm">During the 30-day grace period, you can contact us to recover your account.</p>
          </section>
          ...
          <section>
            ...
            <p>We may update this Privacy Policy from time to time. We will notify you of significant changes via email or in-app notification at least <strong className="text-n2f-text">14 days</strong> before they take effect. Continued use of the Service after changes constitutes acceptance of the updated policy.</p>
          </section>
          ...
          <section>
            ...
            <div className="bg-n2f-elevated rounded-lg p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <a href="mailto:privacy@node2flow.net" className="text-n2f-accent hover:underline">privacy@node2flow.net</a>
              </div>
            </div>
            <p className="mt-4 text-sm text-n2f-text-muted">We aim to respond to all privacy requests within 30 days.</p>
          </section>
        </div>

        {!user && (
          <div className="mt-12 pt-8 border-t border-n2f-border flex justify-between">
            <Link to="/terms" className="text-n2f-accent hover:underline">&larr; Terms of Service</Link>
            <Link to="/" className="text-n2f-accent hover:underline">Back to Home &rarr;</Link>
          </div>
        )}
    </>
  );
